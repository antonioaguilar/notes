...
python3 python3-pip python3-pipdeptree python3-opencv python3-pygments python3-bs4 python3-dev \
...
libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libgstreamer-plugins-bad1.0-dev gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav gstreamer1.0-tools gstreamer1.0-x gstreamer1.0-alsa gstreamer1.0-gl gstreamer1.0-gtk3 gstreamer1.0-qt5 gstreamer1.0-pulseaudio gstreamer1.0-opencv gstreamer1.0-rtsp gstreamer1.0-python3-plugin-loader python3-gst-1.0 python3-gi
